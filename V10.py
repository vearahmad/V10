...
　\33[1;35m　　　　∠_,,,/
                                               {asu}MR,VEAR-XD{P}     
{asu}---------------------------------------------------{P}
 Tool Name {M}:{N} MR,VEAR{P}
 Status    {M}:\033[1;32m FILE x ID PUBLIC{P}
 Version   {M}: {H}G1\033[1;37m
{asu}---------------------------------------------------{P}""")
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def crackmobile_DYNO(idf,pwv,nmf):
	...
	fff = '%'
	sys.stdout.write('\r\x1b[1;90m[%s\x1b[1;91mMR,VEAR\x1b[1;90m]-[\x1b[1;96m%s\x1b[1;90m/\x1b[1;95m%s\x1b[1;90m]-[\x1b[1;92mOK:%s\x1b[1;90m]-[\x1b[1;93mCP:%s\x1b[1;90m]-[\x1b[1;94m%s%s\x1b[1;90m]%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x));sys.stdout.flush()
